...
public class AuditModif {
	...
	public AuditModif(int id, int idAudit, String oldDesignation, String newDesignation, String oldEtat, String newEtat,
			String oldDateDebut, String newDateDebut, String oldDateFin, String newDateFin, String oldDateLimite,
			String newDateLimite, String dateModif, int oldNote, int newNote, Modele oldModele, Modele newModele,
			Jury oldJury, Jury newJury, Matiere oldMatiere, Matiere newMatiere, Lieu oldLieu, Lieu newLieu,
			String oldChamp, String newChamp, String commentaire) {
		super();
		this.id = id;
